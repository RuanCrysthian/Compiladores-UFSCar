...
public class laParser extends Parser {
	...
	public static final int
		...
		T__52=53, PALAVRA_CHAVE=54, IDENT=55, OPERADOR_ARITMETICO=56, OPERADOR_RELACIONAL=57, 
		OPERADOR_BOOLEANO=58, DELIMITADOR=59, ABRE_PARENTESE=60, FECHA_PARENTESE=61, 
		VIRGULA=62, ABRE_COLCHETE=63, FECHA_COLCHETE=64, NUM_INT=65, NUM_REAL=66, 
		CADEIA=67, COMENTARIO=68, WS=69, CADEIA_NAO_FECHADA=70, COMENTARIO_NAO_FECHADO=71, 
		ERRO=72;
	public static final int
		RULE_programa = 0, RULE_declaracoes = 1, RULE_decl_local_global = 2, RULE_declaracao_local = 3, 
		RULE_varialvel = 4, RULE_identificador = 5, RULE_dimensao = 6, RULE_tipo = 7, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"programa", "declaracoes", "decl_local_global", "declaracao_local", "varialvel", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "PALAVRA_CHAVE", "IDENT", "OPERADOR_ARITMETICO", 
			"OPERADOR_RELACIONAL", "OPERADOR_BOOLEANO", "DELIMITADOR", "ABRE_PARENTESE", 
			"FECHA_PARENTESE", "VIRGULA", "ABRE_COLCHETE", "FECHA_COLCHETE", "NUM_INT", 
			"NUM_REAL", "CADEIA", "COMENTARIO", "WS", "CADEIA_NAO_FECHADA", "COMENTARIO_NAO_FECHADO", 
			"ERRO"
		};
	}
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 655448L) != 0) {
				{
				{
				setState(105);
				decl_local_global();
	...
	public static class Declaracao_localContext extends ParserRuleContext {
		public VarialvelContext varialvel() {
			return getRuleContext(VarialvelContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class VarialvelContext extends ParserRuleContext {
		...
		public VarialvelContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_varialvel; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof laListener ) ((laListener)listener).enterVarialvel(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof laListener ) ((laListener)listener).exitVarialvel(this);
		}
	}

	public final VarialvelContext varialvel() throws RecognitionException {
		VarialvelContext _localctx = new VarialvelContext(_ctx, getState());
		enterRule(_localctx, 8, RULE_varialvel);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(175);
			_la = _input.LA(1);
			if ( !((((_la - 13)) & ~0x3f) == 0 && ((1L << (_la - 13)) & 31525197391593475L) != 0) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class RegistroContext extends ParserRuleContext {
		public List<VarialvelContext> varialvel() {
			return getRuleContexts(VarialvelContext.class);
		}
		public VarialvelContext varialvel(int i) {
			return getRuleContext(VarialvelContext.class,i);
		}
	...
	public static class Declaracao_globalContext extends ParserRuleContext {
		public TerminalNode IDENT() { return getToken(laParser.IDENT, 0); }
		public TerminalNode ABRE_PARENTESE() { return getToken(laParser.ABRE_PARENTESE, 0); }
		public TerminalNode FECHA_PARENTESE() { return getToken(laParser.FECHA_PARENTESE, 0); }
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case T__16:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 36029160241500160L) != 0) {
					{
					{
					setState(199);
					cmd();
	...
	public final Exp_relacionalContext exp_relacional() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 2181431069507616L) != 0) {
				{
				setState(505);
				op_relacional();
				setState(506);
