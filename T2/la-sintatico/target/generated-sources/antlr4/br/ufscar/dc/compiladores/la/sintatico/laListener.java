...
public interface laListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link laParser#varialvel}.
	 * @param ctx the parse tree
	 */
	void enterVarialvel(laParser.VarialvelContext ctx);
	/**
	 * Exit a parse tree produced by {@link laParser#varialvel}.
	 * @param ctx the parse tree
	 */
	void exitVarialvel(laParser.VarialvelContext ctx);
	/**
